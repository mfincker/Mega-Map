<template>
  ...
  <div id="blm-statement">
    ...
    <p>
      As allies, our ears are open to the needs of the Black community. If there are ways our tool can better support your needs, we are
      listening. We will also extend a hand to any organization or resource builder who might need support in collecting, processing, or
