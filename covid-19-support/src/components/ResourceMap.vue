...
export default {
  ...
  methods: {
    ...
    editAttributionDisplay() {
      ...
      attributionControl.className = 'leaflet-control-attribution leaflet-control attributions'
    },
    latLng,
  ...
  watch: {
    ...
    showKey: function (val) {
      const attributionControl = this.$el.querySelector('.leaflet-control-attribution')
      val
        ? (attributionControl.className = 'leaflet-control-attribution leaflet-control attributions show-key')
        : (attributionControl.className = 'leaflet-control-attribution leaflet-control attributions')
      const wordmarkControl = this.$el.querySelector('.mapbox-wordmark')
      val ? (wordmarkControl.className = 'mapbox-wordmark show-key') : (wordmarkControl.className = 'mapbox-wordmark')
    }
  }
}
</script>
